...
func (b CefBrowserT) GetFrameNames() []string {
    ...
    for i := range goList {
        var cefName *C.cef_string_t = C.cefString16CastToCefString(C.cef_string_userfree_utf16_alloc())
        ...
        C.cef_string_userfree_utf16_free(C.cefStringCastToCefString16(cefName))
    }
    return goList
}
